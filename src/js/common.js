...
var _extends = Object.assign || function (target) {
		...
		(function (global, factory) {
			...
			module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.LazyLoad =
			factory();
		})(this, function () {
			'use strict';
			...
			var removeClass = function removeClass(element, className) {
				...
				element.className = element.className.replace(new RegExp("(^|\\s+)" + className + "(\\s+|$)"), " ").replace(
					/^\s+/, "").replace(/\s+$/, "");
			};
